...
export const ROADMAP_SECTIONS: RoadmapSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Village leadership — merit elections every 10 years (base)', status: 'done' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Rival diplomacy core — peace, raids, preview, show-militia parade', status: 'done' },
      { label: 'Visitor tribes core — 7 kinds, caravan, refugee negotiate, leader talk', status: 'done' },
      {
        label: 'Roads — walk speed, adjacency, rotation (road-following AI cut)',
        status: 'done',
        note: 'Snap commute is enough',
      },
      {
        label: 'Reputation base — Village explainer + header ⭐ (arc UI → v0.5 P1)',
        status: 'done',
      },
    ],
  },
  {
    ...
    subtitle: 'Base scope shipped in v0.4.1/0.4.2 — only remaining gaps listed here',
    items: [
      {
        label: 'Perf at ~1250 entities (300 player + neighbors)',
        status: 'partial',
        note: 'Target v0.5.0 (P0) — dual-layer grid, city benchmark w/ frontier spawns',
      },
      {
        label: 'UI at 300 population',
        status: 'partial',
        note: 'Target v0.5.0 (P0) — tab split + settler count denorm',
      },
      {
        label: 'Frontier counter-raid visuals',
        status: 'partial',
        note: 'Target v0.5.0 (P1) — v0.4.2 base done; outgoing march + sprites',
      },
      {
        label: 'Reputation arc UI',
        status: 'open',
        note: 'Target v0.5.0 (P1) — v0.4.2 ⭐ + explainer done; milestone beats',
      },
      {
        label: 'Visitor quest depth',
        status: 'open',
        note: 'Target v0.5.0 (P1) — v0.4.1 leader talk done; one multi-step chain',
      },
      {
        label: 'Election ceremony playtest',
        status: 'partial',
        note: 'Target v0.5.0 (P1) — shipped in code; verify Year 10/20',
      },
    ],
  },
  {
